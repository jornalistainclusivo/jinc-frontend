...
export default async function ArtigoPage({ params }: ArtigoPageProps) {
  ...
  try {
    ...
    if (Array.isArray(article.blocks)) {
      // Use unknown cast: Strapi Rich Text nodes are opaque object[] by design
    ...
    // Fallback de retro-compatibilidade com field conteudo antigo
          ...
          {plainTextContent && (
            <div className="flex flex-col md:flex-row items-center justify-between gap-8 mb-12 border-y border-neutral-200 py-6">
              <div className="flex-1 w-full relative">
                <ArticleAudioPlayer title={article.title} text={plainTextContent} />
              </div>
