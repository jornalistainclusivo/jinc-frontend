...
## 7. Ortografia e Acentuação Técnica

Para garantir a acessibilidade cognitiva e a indexação correta por buscadores (SEO):

- **Acentuação:** Títulos de categorias **devem** ser exibidos com acentuação correta e inicial maiúscula (ex: **Saúde**, **Notícias**, **Direitos PcD**), independentemente do slug técnico do banco de dados.
- **Mapeamento:** O mapeamento deve ser feito via dicionário `CATEGORY_DISPLAY_NAMES` no frontend, garantindo que o usuário com deficiência visual ou intelectual receba o termo gramaticalmente correto em vez do termo técnico.
- **Consistência:** A regra de ouro é "O usuário vê o termo correto; o sistema usa o slug otimizado".
